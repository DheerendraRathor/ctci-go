...
func GetKthFromLast(list *collections.LinkedList, k int32) interface{} {
...
func LengthOfList(list *collections.LinkedList) int32 {
    var count int32 = 0
...
func GetIthElement(list *collections.LinkedList, i int32) (interface{}, error) {
